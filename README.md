...
review provenance now cover 254/722 units and 2,512 aligned segments through
OLP-0257. Computability Theory is complete in source, including Rice's theorem
and fixed points; the Turing Machines part has begun through configurations
and computations. Twenty-four source chapters are complete; OLP-0258 is next.
...
- **In-progress chapter:** [Turing Machine Computations](mr/content/turing-machines/machines-computations/), translated through configurations and computations.
...
- **Current editable-source checkpoint evidence:** `provenance/source-checkpoint-254/`; the frozen v0.9 release snapshot remains in `provenance/source-checkpoint-194/`.
...
consultation records across 194 units. The editable working source has 2,512
such records across 254 units; its sixty later units are not yet paginated.
...
the incremental 254-unit editable-source checkpoint.
...
unavailable. The synchronized root provenance now covers 254 translated units and
2,512 aligned segments through OLP-0257. A bounded independent model audit of
