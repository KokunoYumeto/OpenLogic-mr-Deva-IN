...
review provenance now cover 260/722 units and 2,567 aligned segments through
OLP-0263. Computability Theory and Turing Machine Computations are complete
in source, including fixed points, machine variants and the Church--Turing
thesis. Twenty-five source chapters are complete; OLP-0264 is next.
...
- **Current editable-source checkpoint evidence:** `provenance/source-checkpoint-260/`; the frozen v0.9 release snapshot remains in `provenance/source-checkpoint-194/`.
...
consultation records across 194 units. The editable working source has 2,567
such records across 260 units; its sixty-six later units are not yet paginated.
...
the incremental 260-unit editable-source checkpoint.
...
unavailable. The synchronized root provenance now covers 260 translated units and
2,567 aligned segments through OLP-0263. A bounded independent model audit of
