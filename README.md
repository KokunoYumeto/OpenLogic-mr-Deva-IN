...
Editable work has progressed through OLP-0064: **61/722 units** and 725 aligned
translated content blocks. The Sets, Relations, Functions, Size of Sets,
Arithmetization, Infinite Sets, and Syntax and Semantics chapters are complete in source and reader form; the First-order Logic proof-systems part and its introduction are translated beyond the current reader boundary. The 83-page PDF
