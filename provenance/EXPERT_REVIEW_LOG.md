...
The current editable-source coverage is **79/722 units** (OLP-0004–OLP-0082, 871 aligned translated content blocks). The current public reader is the 65/722-unit `eight-chapters-v0.6` checkpoint. Decisions without an applied location are pre-adjudications for later units. This is partial coverage and makes no full-corpus claim.
...
- **Literal Marathi line hits:** `mr/content/first-order-logic/sequent-calculus/identity.tex:17, 35`; `mr/content/first-order-logic/sequent-calculus/quantifier-rules.tex:27, 48`; `mr/content/first-order-logic/sequent-calculus/soundness.tex:208`.
- **Authorities actually checked:**
