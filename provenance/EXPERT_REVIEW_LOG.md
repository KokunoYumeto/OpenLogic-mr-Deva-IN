...
The current editable-source coverage is **80/722 units** (OLP-0004–OLP-0083, 876 aligned translated content blocks). The current public reader is the 65/722-unit `eight-chapters-v0.6` checkpoint. Decisions without an applied location are pre-adjudications for later units. This is partial coverage and makes no full-corpus claim.
