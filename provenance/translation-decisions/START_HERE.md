...
OpenLogic translation through OLP-0227. It covers 224/722 source units,
20 complete chapters, 467 applied decisions and
12,344 current decision-level occurrence records. The remaining 498 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 12,344 occurrences.
