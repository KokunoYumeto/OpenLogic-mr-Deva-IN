...
OpenLogic translation through OLP-0269. It covers 266/722 source units,
20 complete chapters, 512 applied decisions and
13,560 current decision-level occurrence records. The remaining 456 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 13,560 occurrences.
