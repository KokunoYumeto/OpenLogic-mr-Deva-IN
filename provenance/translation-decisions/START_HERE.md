...
OpenLogic translation through OLP-0080. It covers 77/722 source units,
8 complete chapters, 226 applied decisions and
5,063 current decision-level occurrence records. The remaining 645 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,063 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 77-unit
