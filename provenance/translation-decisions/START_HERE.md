...
OpenLogic translation through OLP-0070. It covers 67/722 source units,
8 complete chapters, 212 applied decisions and
4,723 exact current occurrences. The remaining 655 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,723 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 67-unit
