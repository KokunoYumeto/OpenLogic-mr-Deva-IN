...
OpenLogic translation through OLP-0084. It covers 81/722 source units,
8 complete chapters, 226 applied decisions and
5,573 current decision-level occurrence records. The remaining 641 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,573 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 81-unit
