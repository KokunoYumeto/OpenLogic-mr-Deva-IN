...
OpenLogic translation through OLP-0101. It covers 98/722 source units,
10 complete chapters, 236 applied decisions and
6,472 current decision-level occurrence records. The remaining 624 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 6,472 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 98-unit
