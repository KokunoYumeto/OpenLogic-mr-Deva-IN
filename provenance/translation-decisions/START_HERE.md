...
OpenLogic translation through OLP-0066. It covers 63/722 source units, 
7 complete chapters, 201 applied decisions and 
4,598 exact current occurrences. The remaining 659 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,598 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 63-unit 
