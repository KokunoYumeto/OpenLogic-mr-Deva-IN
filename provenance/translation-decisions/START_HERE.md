...
OpenLogic translation through OLP-0062. It covers 59/722 source units, 
7 complete chapters, 187 applied decisions and 
4,474 exact current occurrences. The remaining 663 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,474 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 59-unit 
