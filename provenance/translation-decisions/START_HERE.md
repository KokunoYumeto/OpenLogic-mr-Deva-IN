...
OpenLogic translation through OLP-0263. It covers 260/722 source units,
20 complete chapters, 507 applied decisions and
13,367 current decision-level occurrence records. The remaining 462 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 13,367 occurrences.
