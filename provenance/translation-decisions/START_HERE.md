...
OpenLogic translation through OLP-0089. It covers 86/722 source units,
8 complete chapters, 231 applied decisions and
5,907 current decision-level occurrence records. The remaining 636 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,907 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 86-unit
