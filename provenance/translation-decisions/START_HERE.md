...
OpenLogic translation through OLP-0158. It covers 155/722 source units,
11 complete chapters, 303 applied decisions and
9,280 current decision-level occurrence records. The remaining 567 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 9,280 occurrences.
