...
OpenLogic translation through OLP-0065. It covers 62/722 source units, 
7 complete chapters, 195 applied decisions and 
4,554 exact current occurrences. The remaining 660 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,554 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 62-unit 
