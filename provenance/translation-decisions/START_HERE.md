...
OpenLogic translation through OLP-0083. It covers 80/722 source units,
8 complete chapters, 226 applied decisions and
5,528 current decision-level occurrence records. The remaining 642 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,528 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 80-unit
