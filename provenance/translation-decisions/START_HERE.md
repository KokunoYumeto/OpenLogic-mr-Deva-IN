...
OpenLogic translation through OLP-0087. It covers 84/722 source units,
8 complete chapters, 227 applied decisions and
5,797 current decision-level occurrence records. The remaining 638 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,797 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 84-unit
