...
OpenLogic translation through OLP-0072. It covers 69/722 source units,
8 complete chapters, 213 applied decisions and
4,771 exact current occurrences. The remaining 653 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,771 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 69-unit
