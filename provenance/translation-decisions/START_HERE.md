...
OpenLogic translation through OLP-0181. It covers 178/722 source units,
11 complete chapters, 373 applied decisions and
10,616 current decision-level occurrence records. The remaining 544 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 10,616 occurrences.
