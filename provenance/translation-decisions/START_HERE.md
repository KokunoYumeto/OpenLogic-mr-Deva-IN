...
OpenLogic translation through OLP-0077. It covers 74/722 source units,
8 complete chapters, 226 applied decisions and
4,956 current decision-level occurrence records. The remaining 648 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,956 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 74-unit
