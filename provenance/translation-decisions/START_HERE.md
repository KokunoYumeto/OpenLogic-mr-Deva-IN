...
OpenLogic translation through OLP-0257. It covers 254/722 source units,
20 complete chapters, 500 applied decisions and
13,196 current decision-level occurrence records. The remaining 468 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 13,196 occurrences.
