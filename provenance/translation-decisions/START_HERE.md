...
OpenLogic translation through OLP-0067. It covers 64/722 source units, 
7 complete chapters, 204 applied decisions and 
4,640 exact current occurrences. The remaining 658 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,640 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 64-unit 
