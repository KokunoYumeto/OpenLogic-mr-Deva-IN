...
OpenLogic translation through OLP-0207. It covers 204/722 source units,
20 complete chapters, 431 applied decisions and
11,708 current decision-level occurrence records. The remaining 518 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 11,708 occurrences.
