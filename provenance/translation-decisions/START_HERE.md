...
OpenLogic translation through OLP-0095. It covers 92/722 source units,
8 complete chapters, 234 applied decisions and
6,306 current decision-level occurrence records. The remaining 630 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 6,306 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 92-unit
