...
OpenLogic translation through OLP-0190. It covers 187/722 source units,
11 complete chapters, 385 applied decisions and
10,933 current decision-level occurrence records. The remaining 535 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 10,933 occurrences.
