...
OpenLogic translation through OLP-0103. It covers 100/722 source units,
10 complete chapters, 236 applied decisions and
6,549 current decision-level occurrence records. The remaining 622 units are untranslated.
The paginated 10-chapter reader ends at OLP-0097; later translated units use pending PDF locators.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 6,549 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 100-unit
