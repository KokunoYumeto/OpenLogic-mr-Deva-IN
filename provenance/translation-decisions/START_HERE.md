...
OpenLogic translation through OLP-0246. It covers 243/722 source units,
20 complete chapters, 487 applied decisions and
12,871 current decision-level occurrence records. The remaining 479 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 12,871 occurrences.
