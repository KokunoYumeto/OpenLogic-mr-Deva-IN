...
OpenLogic translation through OLP-0078. It covers 75/722 source units,
8 complete chapters, 226 applied decisions and
5,004 current decision-level occurrence records. The remaining 647 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,004 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 75-unit
