...
OpenLogic translation through OLP-0202. It covers 199/722 source units,
20 complete chapters, 415 applied decisions and
11,560 current decision-level occurrence records. The remaining 523 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 11,560 occurrences.
