...
5,828 current decision-level occurrence records. The remaining 637 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,828 occurrences.
