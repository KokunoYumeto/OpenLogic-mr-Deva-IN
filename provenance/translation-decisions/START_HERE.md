...
7 complete chapters, 208 applied decisions and 
4,689 exact current occurrences. The remaining 657 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,689 occurrences.
