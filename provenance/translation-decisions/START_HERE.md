...
OpenLogic translation through OLP-0096. It covers 93/722 source units,
8 complete chapters, 234 applied decisions and
6,340 current decision-level occurrence records. The remaining 629 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 6,340 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 93-unit
