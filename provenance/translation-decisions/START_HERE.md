...
OpenLogic translation through OLP-0075. It covers 72/722 source units,
8 complete chapters, 222 applied decisions and
4,873 current decision-level occurrence records. The remaining 650 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 4,873 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 72-unit
