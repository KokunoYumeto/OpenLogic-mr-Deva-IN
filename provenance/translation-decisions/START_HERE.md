...
OpenLogic translation through OLP-0098. It covers 95/722 source units,
10 complete chapters, 235 applied decisions and
6,393 current decision-level occurrence records. The remaining 627 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 6,393 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 95-unit
