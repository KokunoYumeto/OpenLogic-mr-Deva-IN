...
OpenLogic translation through OLP-0086. It covers 83/722 source units,
8 complete chapters, 226 applied decisions and
5,728 current decision-level occurrence records. The remaining 639 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,728 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 83-unit
