...
OpenLogic translation through OLP-0079. It covers 76/722 source units,
8 complete chapters, 226 applied decisions and
5,042 current decision-level occurrence records. The remaining 646 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 5,042 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 76-unit
