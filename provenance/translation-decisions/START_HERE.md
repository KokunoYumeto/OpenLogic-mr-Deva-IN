...
OpenLogic translation through OLP-0236. It covers 233/722 source units,
20 complete chapters, 474 applied decisions and
12,515 current decision-level occurrence records. The remaining 489 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 12,515 occurrences.
