...
OpenLogic translation through OLP-0099. It covers 96/722 source units,
10 complete chapters, 235 applied decisions and
6,422 current decision-level occurrence records. The remaining 626 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 6,422 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 96-unit
