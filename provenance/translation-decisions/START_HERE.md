...
OpenLogic translation through OLP-0092. It covers 89/722 source units,
8 complete chapters, 233 applied decisions and
6,092 current decision-level occurrence records. The remaining 633 units are untranslated.
...
- `DECISION_OCCURRENCES.csv` has one UTF-8 row for each of 6,092 occurrences.
...
from `DECISIONS.json` because they have no occurrence in the current 89-unit
